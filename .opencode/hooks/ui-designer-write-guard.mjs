...
// (.opencode/agent-memory/ui-designer/). Any other target — i.e. anything in the
// project source tree — is denied.
//
// Wired in via .opencode/agents/ui-designer.md frontmatter:
...
const MEMORY_SUBDIR = path.join(".opencode", "agent-memory", "ui-designer");
