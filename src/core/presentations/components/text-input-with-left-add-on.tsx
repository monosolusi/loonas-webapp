  ...
  return (
    <div>
      ...
      <div className="mt-2 flex">
        ...
        <input
          type="text"
          className={`${props.textDirection} focus:outline-primary-default -ml-px block w-full grow rounded-r-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-gray-50 disabled:text-gray-500 disabled:shadow-none sm:text-sm/6`}
          value={props.value ?? ""}
