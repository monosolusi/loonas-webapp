...
export function NegativeStockListImpl() {
  ...
  return (
    <div className="flex flex-col gap-y-6">
      <ListPageHeader title="Stok Negatif" subtitle={meta ? `${meta.total} item` : "Memuat..."} />

      <TableToolbar>
        <div />
        <TableSearch value={search} onChange={setSearch} placeholder="Cari item, varian, atau SKU..." />
      </TableToolbar>
