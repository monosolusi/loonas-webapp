...
import { useLedgerDetailRange } from "@/app/(authenticated)/accounting/ledger/[accountId]/_providers/ledger-detail-range-provider";
...
export function LedgerDetailImpl({ accountId }: LedgerDetailImplProps) {
  ...
  return (
    <div className="flex flex-col gap-y-6">
      <DetailPageHeader backHref="/accounting/ledger" title={accountName} subtitle={accountSubtitle} />
