...
import { ProfitabilityTableRowLoading } from "@/app/(authenticated)/accounting/profitability/_components/profitability-table-row-loading";
import { ProfitabilityTableRowData } from "@/app/(authenticated)/accounting/profitability/_components/profitability-table-row-data";
...
export function ProfitabilityTableRow({ product, variant }: ProfitabilityTableRowProps) {
  ...
  const cogsState = useGetVariantCogs({ productId: product.id, variantId: variant.id });
  ...
  const isLoading = cogsState.loading || grossProfitState.loading || recPriceState.loading;

  function handleClick() {
    router.push(`/accounting/profitability/${product.id}/${variant.id}`);
  }
    ...
    >
      ...
      {isLoading ? (
        ...
        <ProfitabilityTableRowData
          cogs={cogsState.data}
          cogsIncomplete={cogsState.isIncompleteRecipe}
