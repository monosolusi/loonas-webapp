...
import { JournalRow } from "@/app/(authenticated)/accounting/journals/_components/journal-row";
import { useJournalRange } from "@/app/(authenticated)/accounting/journals/_providers/journal-range-provider";
  ...
  return (
    <div className="flex flex-col gap-y-6">
      <ListPageHeader
        ...
        action={
          <Link href="/accounting/journals/new" className="w-full sm:w-auto">
            <PrimaryButton
              label="Jurnal Baru"
