  ...
  return (
    <div className="mx-auto max-w-lg">
      ...
      <p className="mt-1 text-sm text-gray-500">
        ...
        secara aman. Kamu bisa pantau status verifikasi dengan memilih tombol Cek Status di bawah ini. Setelah proses
        verifikasi selesai, kami akan langsung informasikan lewat email, ya.
      </p>
      <ul role="list" className="mt-6 divide-y divide-gray-200 border-t border-b border-gray-200">
          ...
          <div className="group relative flex items-start space-x-3 py-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-sm text-gray-500 group-data-[disabled=true]:text-gray-400">
                Pengen tahu status terbaru akunmu? Klik tombol ini buat ngecek status verifikasi akun kamu
                sekarang juga. Kami akan selalu update status verifikasimu secara real-time di halaman ini.
              </p>
            </div>
        ...
        <li className="group">
          <div className="group relative flex items-start space-x-3 py-4">
            <div className="shrink-0 mt-1">
              <span className="bg-green-600 inline-flex size-10 items-center justify-center rounded-lg">
