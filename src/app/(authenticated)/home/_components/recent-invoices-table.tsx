      ...
      <div className="overflow-hidden shadow-sm ring-1 ring-black/5">
        <table className="min-w-full divide-y divide-gray-300">
          <thead className="bg-gray-50">
            <tr>
              <th scope="col" className="py-3.5 pl-4 text-left text-sm font-semibold sm:pl-8"></th>
              ...
              <th
                scope="col"
                className="hidden py-3.5 pr-4 pl-3 text-right text-sm text-gray-900 sm:table-cell sm:pr-8"
              >
                Tanggal Dibuat
              </th>
            </tr>
              ...
              <tr key={row.id}>
                ...
                <td className="px-3 py-4 text-sm whitespace-nowrap text-gray-900 sm:table-cell">
                  <Link
                    ...
                    className="hover:text-primary-default line-clamp-2 cursor-pointer font-bold underline"
                  >
                    {row.partnerName}
                  </Link>
                </td>
                <td className="hidden px-3 py-4 text-center text-sm whitespace-nowrap text-gray-500 sm:table-cell">
