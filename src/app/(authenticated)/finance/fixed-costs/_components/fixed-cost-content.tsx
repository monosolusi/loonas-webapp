...
import { FixedCostEmptyState } from "@/app/(authenticated)/finance/fixed-costs/_components/fixed-cost-empty-state";
import { FixedCostToolbar } from "@/app/(authenticated)/finance/fixed-costs/_components/fixed-cost-toolbar";
