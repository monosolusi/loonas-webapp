...
import { CogsBlockLoading } from "@/app/(authenticated)/finance/profitability/[productId]/[variantId]/_components/cogs-block-loading";
import { DataKurangCard } from "@/app/(authenticated)/finance/profitability/[productId]/[variantId]/_components/data-kurang-card";
import { CogsBlockError } from "@/app/(authenticated)/finance/profitability/[productId]/[variantId]/_components/cogs-block-error";
import { CogsBlockBody } from "@/app/(authenticated)/finance/profitability/[productId]/[variantId]/_components/cogs-block-body";
