...
import { CreateAccountBankAccountButton } from "@/app/(authenticated)/settings/bank-accounts/create/_components/create-button";
  ...
  return (
    <div className="flex flex-row items-start justify-center">
      <Card className="w-full max-w-md">
        <div className="-mx-4 flex flex-col space-y-8 sm:-mx-6">
          <div className="flex flex-col space-y-2 px-4 sm:px-6">
            ...
            <p className="text-sm text-gray-400">
              Pastikan rekening ini terdaftar atas nama bisnismu, ya. Ini penting untuk kelancaran proses pembayaran.
            </p>
          </div>
          ...
          <div className="flex flex-row justify-end space-x-4 border-t border-gray-200 px-4 pt-4 sm:px-6">
            <CancelButton />
