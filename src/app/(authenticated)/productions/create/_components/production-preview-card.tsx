...
export function ProductionPreviewCard() {
  ...
  if (!product || !variantId || quantity <= 0) return null;

  if (previewLoading) {
    return (
      <SectionCard title="Estimasi Bahan Baku" iconSrc="/assets/images/chart-icon-primary-300-w16-h16.svg">
        <div className="flex items-center justify-center py-8">
          <span className="text-sm text-neutral-300">Menghitung estimasi...</span>
        </div>
      </SectionCard>
    );
  }
  ...
  return (
    <SectionCard title="Estimasi Bahan Baku" iconSrc="/assets/images/chart-icon-primary-300-w16-h16.svg">
      <div className="-mx-6 -mb-6">
        <div className="grid grid-cols-[1.5fr_0.8fr_0.8fr_1fr_0.8fr] gap-x-4 border-b border-neutral-100 bg-neutral-50 px-4 py-2">
          <span className="text-xs font-medium tracking-wider text-neutral-300 uppercase">Bahan Baku</span>
          <span className="text-xs font-medium tracking-wider text-neutral-300 uppercase">Qty Dipakai</span>
          ...
          <span className="text-right text-xs font-medium tracking-wider text-neutral-300 uppercase">Stok</span>
        </div>
