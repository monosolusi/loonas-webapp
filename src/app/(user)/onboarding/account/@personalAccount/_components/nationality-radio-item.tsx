...
export function NationalityRadioItem(props: NationalityRadioItemProps) {
  return (
    <label className="group has-checked:outline-primary-300 relative flex flex-row gap-3 rounded-xl border-2 border-neutral-100 p-6 has-checked:outline-2 has-checked:-outline-offset-2">
      <input type="radio" name="wni" className="absolute inset-0 appearance-none focus:outline-none" />
