...
import {
  StockItemService,
  ListStockItemsServiceResult,
  ListStockItemsServiceParams,
  UpdateStockItemServiceParams,
} from "@/features/inventory/domain/sources/stock-item";

export class StockItemServiceImpl implements StockItemService {
  constructor(private readonly http: HttpRequest) {}

  public async list(params: ListStockItemsServiceParams, session: SessionEntity): Promise<ListStockItemsServiceResult> {
    try {
  ...
  public async listLowStock(
    params: ListStockItemsServiceParams,
  ...
  public async listNegativeStock(
    ...
    try {
      ...
      const result = await this.http.request({
        path: "/inventory/stock-items/negative-stock",
        method: "GET",
        searchParams,
        session,
      });
  ...
  public async update(params: UpdateStockItemServiceParams, session: SessionEntity): Promise<StockItemModel> {
    try {
      const result = await this.http.request({
