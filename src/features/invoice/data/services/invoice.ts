...
export abstract class InvoiceService {
  public abstract list(filter: InvoiceServiceFilter, session: SessionEntity): Promise<InvoiceModel[]>;
}

export class InvoiceServiceImpl implements InvoiceService {
  public async list(filter: InvoiceServiceFilter, session: SessionEntity): Promise<InvoiceModel[]> {
    try {
