...
export class GetJournalUseCaseParams {
  constructor(public readonly id: string) {}
}

export class GetJournalUseCase implements UseCase<DataState<JournalEntity>, GetJournalUseCaseParams> {
  constructor(
    private readonly repo: JournalRepository,
    private readonly sessionRepo: SessionRepository,
  ) {}

  public async execute(params: GetJournalUseCaseParams): Promise<DataState<JournalEntity>> {
    try {
