...
import {
  GetManagerialCostFetcherParams,
  UseGetManagerialCostParams,
  UseGetManagerialCostState,
} from "@/features/accounting/presentations/hooks/use-get-managerial-cost.types";

async function GetManagerialCostFetcher([_, fp]: [string, GetManagerialCostFetcherParams]) {
