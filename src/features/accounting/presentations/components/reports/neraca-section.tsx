...
import { NeracaSectionEntity } from "@/features/accounting/domain/entities/neraca";
import { BalanceDisplay } from "@/features/accounting/presentations/components/reports/balance-display";

type NeracaSectionProps = {
  section: NeracaSectionEntity;
};

export function NeracaSection({ section }: NeracaSectionProps) {
