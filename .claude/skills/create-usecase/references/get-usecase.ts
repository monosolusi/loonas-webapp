// Canonical example: get-by-id use case with single-arg params class.
// Source: src/features/production/domain/usecases/get-production-record.usecases.ts
...
export class GetProductionRecordUseCaseParams {
  // Single-field input: a shorthand constructor is fine.
