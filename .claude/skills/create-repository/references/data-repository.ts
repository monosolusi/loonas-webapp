// Canonical example: data repository implementation.
// Delegates to service, maps Model → Entity, wraps errors in DataState.
// Source: src/features/production/data/repositories/production-record.ts
