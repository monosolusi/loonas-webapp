// Canonical example: model with array of child models + Array.isArray guard.
// Source: src/features/production/data/models/production-record.ts
...
export class ProductionRecordModel implements AbstractModel {
  ...
  public static fromJson(data: Record<string, any>): ProductionRecordModel {
    // Guard array fields — API may omit or send null.
